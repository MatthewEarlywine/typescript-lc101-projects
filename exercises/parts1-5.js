...
console.log("It will take the " + spaceShuttle.name + " " + spaceShuttle.getDaysToLocation(kilometersToMars) + " days to reach Mars.");
console.log("It will take the " + spaceShuttle.name + " " + spaceShuttle.getDaysToLocation(kilometersToTheMoon) + " days to reach the Moon.");
